...
const Navbar = ({setIsMobileOpen, user, handelLogout, FaAngleLeft}) => {
    ...
    return (
      <div
        className={`backdrop-blur-sm bg-white/30 py-4 px-5 md:px-10 flex justify-between items-center sticky top-0 z-20 transition-all `}
      >
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-xl font-bold">
            {loaction.pathname === "/dashboard" ? "Home" : loaction}
          </h1>
        </div>
