...
const SentRequests = () => {
  ...
  return (
    <div className="flex justify-center items-center">
      <div className="w-[350px] md:w-[450px] lg:w-[750px] xl:w-[1000px] 2xl:w-full transition-all duration-500 overflow-x-auto bg-gradient-to-br from-blue-100/50 via-gray-200/50 to-green-100/50 p-4 rounded-lg shadow-md border border-gray-300">
