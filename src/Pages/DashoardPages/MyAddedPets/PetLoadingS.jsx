      ...
      <table className="min-w-full table-auto border-collapse rounded-lg">
        <thead>
          <tr className="bg-green-100">
            {["SL", "Pet Name", "Category", "Image", "Adoption Status", "Actions"].map((item, index) => (
              <th key={index} className="px-6 py-3 text-left font-semibold text-gray-700">
                {item}
              </th>
            ))}
          </tr>
        ...
        <tbody>
          {[...Array(6)].map((_, idx) => (
            <tr key={idx} className="border-b">
              ...
              <td className="px-6 py-4"><Skeleton circle width={40} height={40} /></td>
