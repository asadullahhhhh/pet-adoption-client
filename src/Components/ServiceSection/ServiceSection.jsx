  ...
  return (
    ...
    >
      <div className="max-w-7xl relative mx-auto px-4 text-center">
        <div className="flex absolute left-[50%] -top-8 -translate-x-[50%] items-center justify-center gap-5 sm:justify-start mb-10">
          <div className="w-16 h-[3px] bg-amber-300"></div>
          <span className="text-amber-400 font-semibold text-lg sm:text-base mr-2">
            Available Pets
          </span>
        </div>
        <h2 className="text-3xl md:text-5xl font-bold mt-5 text-gray-800 mb-12">
          Taking Care of Pets
        </h2>
